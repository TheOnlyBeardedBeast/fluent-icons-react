...
export const DocumentPageBreakFilled: React.FC<IconProps> = ({ size, color }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
  ...
  >
    ...
    />
    <path
      d="M5 2C4.44772 2 4 2.44772 4 3V7C4 8.104 4.896 9 6 9H18C19.104 9 20 8.104 20 7V3C20 2.44772 19.5523 2 19 2H5Z"
      fill={color}
    />
    <path
      d="M19 22C19.5523 22 20 21.5523 20 21V17C20 15.896 19.104 15 18 15L6 15C4.896 15 4 15.896 4 17L4 21C4 21.5523 4.44772 22 5 22L19 22Z"
      fill={color}
    />
  </svg>
);
