...
export const SmallRegular: React.FC<IconProps> = ({ size, color }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 16 16"
  ...
  >
    ...
    />
    <path
      d="M6 7.5C6 6.67157 6.67157 6 7.5 6H8.5C9.32843 6 10 6.67157 10 7.5V8.5C10 9.32843 9.32843 10 8.5 10H7.5C6.67157 10 6 9.32843 6 8.5V7.5ZM7.5 7C7.22386 7 7 7.22386 7 7.5V8.5C7 8.77614 7.22386 9 7.5 9H8.5C8.77614 9 9 8.77614 9 8.5V7.5C9 7.22386 8.77614 7 8.5 7H7.5Z"
      fill={color}
    />
    <path
